        ...
        <div class="flex justify-between items-center h-16">
            ...
            <nav class="flex items-center space-x-4">
                ...
                <a href="{{ route('cart.index') }}" class="relative p-2 text-gray-600 hover:text-blue-600"
                    ...
                    <span
                        class="cart-count-badge absolute -top-1 -right-1 flex h-5 w-5 items-center justify-center rounded-full bg-red-500 text-xs font-semibold text-white transition-transform duration-200">
                        {{ $cartItemCount }}
                    </span>
                </a>
