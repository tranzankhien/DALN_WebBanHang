...
<div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
    ...
    <div class="my-6">
        <a href="#" class="block">
            <img src="https://file.hstatic.net/200000722513/file/thang_06_banner_collections_1920x420_-_web_header.png" alt="Banner" class="w-full rounded-lg shadow-sm object-cover">
        </a>
    </div>
    ...
    <div class="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 lg:grid-cols-5 gap-6">
        ...
        <div class="relative bg-white rounded-lg p-4 shadow hover:shadow-md overflow-hidden flex flex-col">
            ...
            <div class="absolute top-3 left-3 z-20 bg-red-500 text-white text-xs font-semibold px-3 py-1 rounded-lg">-{{ $pct }}%</div>
            @endif
            ...
            <a href="{{ route('productInformation', $product->id) }}" class="text-sm font-semibold text-gray-900 block my-1 line-clamp-2">{{ $product->name }}</a>
