            ...
            <div class="flex h-full transition-transform duration-700" :style="`transform:translateX(-${index*100}%);`">
                <template x-for="(a, i) in ads" :key="i">
                    <a :href="a.url" class="w-full h-full flex-shrink-0" target="_blank" rel="noopener">
                        ...
                        <template x-if="!a.image">
                            <div
                                class="w-full h-full bg-gray-100 border border-dashed border-gray-300 flex items-center justify-center text-sm text-gray-500">
                            ...
                            <div
                                ...
                                <div class="p-3">
                                    <p class="text-xs text-gray-500 mb-1 truncate">
                                        {{ $product->inventoryItem->category->name ?? $cat->name }}
                                    </p>
